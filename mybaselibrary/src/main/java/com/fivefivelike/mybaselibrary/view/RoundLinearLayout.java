...
public class RoundLinearLayout extends LinearLayout {
    ...
    public RoundLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            float radius = ta.getDimension(R.styleable.RoundLinearLayout_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.RoundLinearLayout_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.RoundLinearLayout_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.RoundLinearLayout_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.RoundLinearLayout_bottomRightRadius, radius);
            ta.recycle();
        }
