...
public class PercentageFrameLayout extends FrameLayout {
    ...
    public PercentageFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PercentageFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PercentageFrameLayout, 0, defStyle);
        whichIsFinal = ta.getInt(R.styleable.PercentageFrameLayout_whichIsFinal, WHICH_IS_FINAL_WIDTH);
        widWeight = ta.getInteger(R.styleable.PercentageFrameLayout_wid_weight, 1);
        heiWeight = ta.getInteger(R.styleable.PercentageFrameLayout_hei_weight, 1);
        ta.recycle();
    }
